<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        {{-- Normal --}}
        <li
            class="menu-item {{ request()->routeIs(['Expense.index', 'Expense.create', 'Expense.history']) ? 'active open' : '' }}">
        ...
        @if (isset($userModuleRoles['AllSystems']) ||
            ...
            <li
                class="menu-item {{ request()->routeIs(['DriverClaim.index', 'DriverClaim.create', 'DriverClaim.history']) ? 'active open' : '' }}">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons mdi mdi-list-box-outline"></i>
                ...
                <ul class="menu-sub">
                    <li
                        class="menu-item {{ request()->routeIs(['DriverClaim.index', 'DriverClaim.create']) ? 'active' : '' }}">
        ...
        @if (isset($userModuleRoles['AllSystems']) ||
            ...
            <li
                class="menu-item {{ request()->routeIs(['TechClaim.index', 'TechClaim.create', 'TechClaim.history']) ? 'active open' : '' }}">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons mdi mdi-list-box-outline"></i>
                ...
                <ul class="menu-sub">
                    <li
                        class="menu-item {{ request()->routeIs(['TechClaim.index', 'TechClaim.create']) ? 'active' : '' }}">
        ...
        @if (isset($userModuleRoles['AllSystems']) ||
            ...
            <li
                ...
                <ul class="menu-sub">
                    ...
                    <li
                        class="menu-item {{ request()->routeIs(['HR.approved', 'HR.hrnextapprove']) ? 'active' : '' }}">
        ...
        @if (isset($userModuleRoles['AllSystems']) ||
            ...
            <li
                class="menu-item {{ request()->routeIs(['Account.index', 'Account.manage', 'Account.view', 'Account.listhold', 'Account.listapproved']) ? 'open' : '' }}">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <ul class="menu-sub">
                    <li
                        class="menu-item {{ request()->routeIs(['Account.index', 'Account.manage']) ? 'active' : '' }}">
                        <a href="{{ route('Account.index') }}" class="menu-link">
                            <div data-i18n="รายการกลุ่มอนุมัติ">รายการกลุ่มอนุมัติ</div>
                        </a>
                    </li>
                    <li
                        class="menu-item {{ request()->routeIs(['Account.listapproved', 'Account.view']) ? 'active' : '' }}">
        ...
        @if (isset($userModuleRoles['AllSystems']) ||
            ...
            {{-- User --}}
            <li
                class="menu-item {{ request()->routeIs(['User.index', 'User.create', 'Role.index', 'Role.create']) ? 'active open' : '' }}">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        @if (isset($userModuleRoles['AllSystems']) ||
            ...
            <li
                ...
                <ul class="menu-sub">
                    ...
                    <li
                        class="menu-item {{ request()->routeIs(['importlist.index', 'Typegroup.index']) ? 'active' : '' }}">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ asset('storage/manuals/Expense_Claims_MU_BG_V0.2.pdf') }}" class="menu-link"
                        target="_blank" rel="noopener">
                        <div data-i18n="พนักงานทั่วไป">พนักงานทั่วไป</div>
                    </a>
                    <a href="{{ asset('storage/manuals/Expense_Claims_MU_HR_V0.2.pdf') }}" class="menu-link"
                        target="_blank" rel="noopener">
                        <div data-i18n="HR">HR</div>
                    </a>
                    <a href="{{ asset('storage/manuals/Expense_Claims_MU_AC_V0.2.pdf') }}" class="menu-link"
                        target="_blank" rel="noopener">
                        <div data-i18n="Account">Account</div>
                    </a>
                    <a href="{{ asset('storage/manuals/Expense_Claims_MU_Setting_V0.2.pdf') }}" class="menu-link"
                        target="_blank" rel="noopener">
                        <div data-i18n="Setting">Setting</div>
                    </a>
                </li>
