            ...
            <div class="colxxl">
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <form action="{{ route('ACgroup.updatelist') }}" id="editListHR" method="POST">
                            @csrf
                            <div class="row" id="content-check">
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating form-floating-outline">
                                        ...
                                        <input type="hidden" name="groupid" id="groupid" value="{{ $approveStaff->headid }}">
                                        <input type="hidden" name="step" id="step" value="{{ $approveStaff->step }}">
                                    </div>
                                </div>
                                @if($approveStaff->step == 1)
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating form-floating-outline">
                                ...
                                <div class="mt-3 text-center">
                                    <button type="submit"  class="btn btn-primary"><span
                                            ...
                                            <a href="{{ route('ACgroup.edit',$approveStaff->headid) }}" class="btn btn-danger">กลับ</a>
                                </div>
                            </div>
                        </form>
