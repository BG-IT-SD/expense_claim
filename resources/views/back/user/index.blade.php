                ...
                <tbody>
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td>{{ $user->email }}</td>
                            <td>
                                <button class="btn btn-sm btn-info rolemodal" data-id="{{ $user->id }}" data-empid="{{ $user->empid }}" data-fullname="{{ $user->fullname }}"><span class="mdi mdi-account-key"></span> &nbsp;Role</button>
                            </td>
                            <td>
                                {!! $user->status == 1
                            ...
                            <td>
                                <button class="btn btn-warning btn-sm btnedit" onclick="window.location.href='{{ route('User.edit', $user->id) }}'"><i class="mdi mdi-pencil-circle-outline"></i>
                                    edit</button> <button type="button"
                                    class="btn btn-danger btn-sm deleteuser" data-id="{{ $user->id }}"><i
