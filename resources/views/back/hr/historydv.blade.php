    ...
    <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form id="searchExpense" action="{{ route('DriverClaim.history') }}" method="GET">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="row justify-content-end">
                                        <div class="col-sm-9">
                                            ...
                                            <a href="{{ route('DriverClaim.history') }}"
        ...
        <div class="row">
            <div class="col-12 mb-4">
                <div class="card">
                    <h5 class="card-header"><i class="mdi mdi-view-list"></i> รายการอนุมัติแล้ว พขร.</h5>
                    <div class="table-responsive text-nowrap2">
                        <table class="table" id="historydriver">
