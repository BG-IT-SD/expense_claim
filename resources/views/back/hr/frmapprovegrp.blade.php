                    ...
                    <form onsubmit="return false">
                        ...
                        <div id="account-details" class="content">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-floating form-floating-outline">
                                        <input type="text" id="email" class="form-control" value="11/11/2024 8:30 น." aria-label="john.doe">
                                ...
                                <div class="col-sm-6 form-password-toggle">
                                    <div class="input-group input-group-merge">
                                        <div class="form-floating form-floating-outline">
                                            <input type="text" id="confirm-password" class="form-control" value="PTI" aria-describedby="confirm-password2">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-floating form-floating-outline">
                                        <input type="text" id="email" class="form-control" value="11/11/2024 15:30 น." aria-label="john.doe">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-floating form-floating-outline">
                                        <input type="text" id="email" class="form-control" value="15:30 น." aria-label="john.doe">
                                        <label for="email">ถึงเวลา</label>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-floating form-floating-outline">
                                        <input type="text" id="email" class="form-control" value="70.7" aria-label="john.doe">
                            ...
                            <div class="row g-4">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio7" value="option7" checked>
                                        ...
                                        <div class="table-responsive text-nowrap">
                                            <table class="table table-striped">
                                                ...
                                                <tbody class="table-border-bottom-0">
                                                    <tr>
                                                        <td><span class="badge rounded-pill bg-label-dark me-1">EX20241102</span></td>
                                                        <td>
                                                            <i class="mdi mdi-account mdi-20px text-danger me-3"></i><span class="fw-medium">กมลวรรณ บรรชา</span>
                                                        </td>
                                                        <td>66000510</td>
                                                    ...
                                                    <tr>
                                                        <td><span class="badge rounded-pill bg-label-dark me-1">EX20241101</span></td>
                                                        <td>
                                                            <i class="mdi mdi-account mdi-20px text-info me-3"></i><span class="fw-medium">เสาวภา เข็มเหลือง</span>
                                                        </td>
                                                        <td>63000455</td>
                                            ...
                                            <div class="table-responsive text-nowrap">
                                                <table class="table table-bordered text-center">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <i class="mdi mdi-food-outline mdi-20px text-danger me-3"></i><span class="fw-medium">เบิกมื้ออาหาร</span>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <span class="badge rounded-pill bg-label-success me-1">4 มื้อ</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <i class="mdi mdi-domain mdi-20px text-info me-3"></i><span class="fw-medium">บริษัทฯ จัดอาหารให้</span>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <div class="form-check form-check-inline form-check-danger">
                                                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox44" value="option44">
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <span class="badge rounded-pill bg-label-danger me-1">2 มื้อ</span>
                                                            </td>
                                                        </tr>
                                                        <tr class="table-info">
                                                            <td>
                                                                <i class="mdi mdi-currency-usd mdi-20px text-info me-3"></i><span class="fw-medium">รวม</span>
                                                            </td>
                                                            <td>50</td>
                                                            <td>60</td>
                                                            <td>0</td>
                        ...
                        <div id="social-links" class="content active dstepper-block">
                            ...
                            <div class="row g-4">
                                    ...
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 pt-3">
                                                <h5><span class="badge rounded-pill bg-label-primary me-1">34.12</span></h5>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-floating form-floating-outline">
                                        <input type="number" id="google" min="0" class="form-control" placeholder="">
                                        <label for="google">รถโดยสารสาธารณะทั่วไป / บาท</label>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-floating form-floating-outline">
                                        <input type="number" id="linkedin" min="0" class="form-control" placeholder="">
                                        <label for="linkedin">ค่าทางด่วน / บาท</label>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-floating form-floating-outline">
                                        <input type="number" id="other" min="0" class="form-control" placeholder="">
                            ...
                            <div class="row g-4">
                                <div class="col-sm-12 text-center">
                                    <div class="form-check form-check-inline mt-3">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio111" value="option111" checked="checked">
                                        <label class="form-check-label" for="inlineRadio111">ประสงค์เบิกน้ำมัน</label>
                                    </div>
                                    <div class="form-check form-check-inline mt-3">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio222" value="option222">
                            ...
                            <div class="row g-4">
                                ...
                                <table class="table table-bordered text-center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>รวม</td>
                                                <td><button type="button" class="btn rounded-pill btn-success waves-effect waves-light">980.00</button></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="row g-4">
                                    <div class="col-sm-12">
                                        <div class="card shadow-none bg-transparent border border-primary mb-3">
                                            <div class="card-body">
                                              <h5 class="card-title "><span class="badge rounded-pill bg-primary">อนุมัติการเบิก</span></h5>
                                              <hr>
                                              <div class="input-group input-group-merge">
                                                <div class="form-floating form-floating-outline">
                                                    <select id="selectpickerBasic2" class="selectpicker w-100" data-style="btn-default" tabindex="null">
