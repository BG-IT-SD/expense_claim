                        ...
                        <form id="approveForm" action="{{ route('Account.exgroup.approve') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" id="paymentdate" name="paymentdate" value=""
                            ...
                            <div class="col-sm-12 mt-3 mb-3">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="hidden" name="nettotalfood" class="row-foodnet"
                                                    data-id="{{ $expense->id }}"
                                                    value="{{ number_format($exgroup->totalfood, 2) }}">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="btn rounded-pill btn-info waves-effect waves-light totaltravelnet">{{ number_format($exgroup->totalother, 2) }}</span>
                                                <input type="hidden" name="nettotalother" class="row-othernet"
                                                    data-id="{{ $expense->id }}"
                                                    value="{{ number_format($exgroup->totalother, 2) }}">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>ค่าน้ำมัน</td>
                                            ...
                                            <td>
                                                <span
                                                    class="btn rounded-pill btn-info waves-effect waves-light gasolinecostnet">{{ number_format($exgroup->totalfuel, 2) }}</span>
                                                <input type="hidden" name="nettotalfuel" class="row-gasnet"
                                                    data-id="{{ $expense->id }}"
                                                    value="{{ number_format($exgroup->totalfuel, 2) }}">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>รวม</td>
                                            ...
                                            <td>
                                                ...
                                                <input type="hidden" name="nettotal" class="row-totalexNet"
                                                    data-id="{{ $expense->id }}" value="{{ round($exgroup->total) }}">
                                            </td>
                                        </tr>
                                ...
                                <div class="text-center row">
                                    <div class="col-md-12 mb-3">
                                        <h5>ผู้อนุมัติ : {{ $approveempid . ' | ' . $approvename }}</h5>
                                        <input type="hidden" name="accountempid" value="{{ $approveempid }}">
                                        <input type="hidden" name="accountemail" value="{{ $approveemail }}">
                                        <input type="hidden" name="exgroup_id" value="{{ $exgroup->id }}">
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <button type="submit" class="btn btn-primary"><span
                                                class="mdi mdi-content-save"></span> บันทึกผลการอนุมัติ</button>
                                    </div>
...
@endsection
@section('jscustom')
    <script src="{{ URL::signedRoute('secure.js', ['filename' => 'js/account/manage.js']) }}"></script>
@endsection
@section('csscustom')
    <style>
        .lock-table {
