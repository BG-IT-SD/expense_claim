            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="GET" action="{{ route('Account.listapproved') }}">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="row justify-content-end">
                                        <div class="col-sm-9">
                                            ...
                                            <a href="{{ route('Account.listapproved') }}" class="btn btn-outline-secondary">Reset</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <table class="table" id="grouplist">
                            ...
                            <tbody class="table-border-bottom-0">
                                @foreach ($exgroups as $exgroup)
                                    <tr>
                                        <td>{{ $exgroup->id }}</td>
                                        <td>{{ \Carbon\Carbon::parse($exgroup->paymentdate)->format('d/m/Y') }}</td>
