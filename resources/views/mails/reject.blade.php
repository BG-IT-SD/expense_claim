            ...
            <tr>
                {{-- @if ($type == 1) --}}
                    <td class="email-body">
                        ...
                        <p><strong>เรื่อง แจ้งผลการไม่อนุมัติการเบิกเบี้ยเลี้ยงหรือค่าเดินทาง {{ 'EX'.$expenseid }}</strong>
                        </p>
                        <p>รายการเบิกเบี้ยเลี้ยงหรือค่าเดินทางของวันที่ {{ $departuredate }}</p>
                        <p>ไม่ผ่านการอนุมัติ จากคุณ{{ $headname }}</p>
