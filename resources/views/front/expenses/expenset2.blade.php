  ...
  <div class="row g-4">
    @foreach ($Alldayfood as $index => $dayFood)
      @php
        ...
        // ติ๊กอัตโนมัติตามเกณฑ์เดิมของคุณ
              ...
              <table class="table table-bordered text-center">
                <thead>
                  <tr class="table-info">
                    ...
                    <th><h5>มื้อเช้า</h5></th>
                    <th><h5>มื้อกลางวัน</h5></th>
                    <th><h5>มื้อเย็น</h5></th>
                    <th><h5>มื้อดึก</h5></th>
                    <th><h5>รวม</h5></th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-check form-check-inline form-check-danger">
                        <input class="form-check-input mealx-checkbox"
                               type="checkbox"
                               name="days[{{ $index }}][mealx1][]"
                               data-price="{{ $groupplant->meal->meal1 }}"
                               data-day="{{ $dayFood->toDateString() }}"
                               value="1">
                      </div>
                    </td>
                    <td>
                  ...
                  <tr class="table-info sumallday">
                    <td><i class="mdi mdi-currency-usd mdi-20px text-info me-3"></i><span class="fw-medium">รวม</span></td>
                    <td>0</td>
                    <td>0</td>
                    <td>0</td>
                    <td>0</td>
