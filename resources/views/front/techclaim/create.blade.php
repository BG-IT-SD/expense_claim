                ...
                <div class="bs-stepper wizard-numbered mt-2">
                    ...
                    <div class="bs-stepper-content">
                        <form id="expensefrm" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="empfullname_tech" value="{{ $empfullname }}">
                            {{-- hidden --}}
                            <!-- Tab1 Details -->
                            ...
                            @includeIf('front.expenses.expenset1')
                            @includeIf('front.expenses.expenset2')
                            @includeIf('front.expenses.expenset3')
                        </form>
                    </div>
                </div>
            </div>
