...
class HRController extends Controller
{
    ...
    public function history()
    {
        ...
        $expensesByPlant = $expenses->groupBy(function ($expense) use ($usercheck) {
            if ((string)$usercheck === '64000417') {
                return 'PTI';
            }

            return BuEmp($expense->empid);
        });
    ...
    public function editapprove($id, $type = null, $approve = null)
    {
        // ส่งตัวแปรบอกว่าเป็นหน้า edit
        $isView = 3;
        if ($type != null) {
